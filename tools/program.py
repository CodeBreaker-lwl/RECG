...
def load_config(file_path):
    ...
    # ======================================================================================================
    # ===============================修改训练模型==============================================================
    merge_config(yaml.load(open("output/rec/r34_vd_none_bilstm_ctc/config.yml", 'rb'), Loader=yaml.Loader))
...
def preprocess(is_train=False):
    ...
    # =====================================================================================================
    # ===============================修改训练模型==============================================================
    config = load_config("output/rec/r34_vd_none_bilstm_ctc/config.yml")

    # 检查在飞浆cpu版本中是否设置use\u gpu=True
